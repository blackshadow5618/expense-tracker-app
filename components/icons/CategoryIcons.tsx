...
const DiningIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.151 12.22C21.65 11.234 22 10.15 22 9c0-4.418-4.03-8-9-8S4 4.582 4 9c0 1.15.35 2.234.849 3.22M12 12v9m0 0H9m3 0h3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 14.5c0 2.485 4.03 4.5 9 4.5s9-2.015 9-4.5" />
    </svg>
);
...
const UtilitiesIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
const TravelIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M5.536 2.464a9 9 0 0112.928 12.928" />
  </svg>
);
...
export const CategoryIcon: React.FC<CategoryIconProps> = ({ category, className = "h-6 w-6" }) => {
  switch (category) {
    case Category.Groceries:
      return <ShoppingCartIcon className={className} />;
    case Category.DiningOut:
      return <DiningIcon className={className} />;
